...
export default {
    ...
    title:"Pre-mainnet of Galaxy Computing Competition",
    title1:"Still need to start the race",
    piece: 'piece',
    countDown:"Countdown to the end of the pre-mainnet",
    countDown1: "GPU computing power main network has been launched",
    Day:'Days',
    Hour:'Hours',
    Minute:'Minutes',
    Second:'Seconds',
    TheEnd:'Times Up',
    desc:"The DeepBrain Chain computing power main network has been launched. When the 5,000 GPUs on the entire network are met, the competition will be automatically activated (30% of the rent of users with less than 5,000 cards will be destroyed. The competition for users who reach 5,000 cards will start. 70% of the rent of users with more than 5,000 cards will be destroyed. 100% of the rent of users with more than 10,000 cards will be destroyed.). After activation, the competition will last for 2 months. During the competition, all computing workers Share 133 million DBC rewards together, and the top 5 hash workers can get an additional 30 million DBC rewards!",
