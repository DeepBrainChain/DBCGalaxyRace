...
export default {
    ...
    title1:"Number of GPUs in DBC decentralized network is",
    piece: '',
    ...
    Second:'Seconds',
    TheEnd:'Times Up',
    desc:"The DeepBrain Chain computing power mainnet has been launched. For users with less than 5,000 cards, 30% of the rental fee will be burned. For users with more than 5,000 cards, 70% of the rental fee will be burned. And for those with over 10,000 cards, 100% of the rental fee will be burned.",
